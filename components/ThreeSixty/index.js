...
import ReactHammer from 'react-hammerjs-18'
...
export default function ThreeSixty({ sku, top, shortDesc, fs, setFs }) { // sku (str), if it has top view or not (boolean)
  ...
  for (let i = 1; i <= 40; i++) {
    ...
    arr.push(`https://www.aiwaelectronics.com.ar/photoserver/products/${sku}/360/${i}.webp`)
  }
    ...
    <div id='threeSixtyContainer'>
      ...
      {!zoom
            ...
            <div className='points-of-interest'>
              {highlightOpen && <TransformWrapper
                ...
                <TransformComponent>
                  ...
                  <img className='hl-image' src={`https://www.aiwaelectronics.com.ar/photoserver/products/${sku}/img/top.webp`} alt='hl-image' />
                </TransformComponent>
              </TransformWrapper>}
            </div>
            {arr.map((e, i) => (
        ...
        : (<TransformWrapper
          ...
          <TransformComponent>
            <img className='zoom-icon' src='/components/threeSixty/zoom-icon.svg' alt='zoom-icon' />
            <Image src={`https://www.aiwaelectronics.com.ar/photoserver/products/${sku}/360/${idx}-hq.webp`} className='not-draggable zoomed' alt='360-image-zoomed' fill unoptimized priority />
          </TransformComponent>
        </TransformWrapper>)}
